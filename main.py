...
API_KEY = "941b5f66bfaf58858d25f27387e837f7"
...
def add():
    ...
    if form.validate_on_submit():
        ...
        url_api = f"https://api.themoviedb.org/3/search/movie?api_key={API_KEY}&query={title}"
        params = {
            'api_key': API_KEY,
            'query': title,
        }
...
def find():
    ...
    if movie_id:
        ...
        url_api = f"https://api.themoviedb.org/3/movie/{movie_id}?api_key={API_KEY}"
        response = requests.get(url=url_api, params=params)
